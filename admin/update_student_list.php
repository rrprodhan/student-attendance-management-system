...
<body>
    <header class="header">
        ...
        <div class="panel panel-default container">
            ...
            <a href="delete_student_list.php">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-dark" href="update_student.php?id=<?php
                                    echo $row['student_id'];?>&name=<?php
                                    echo $row['student_name'];?>&roll=<?php
                                    echo $row['student_roll_number'];?>&email=<?php
                                    echo $row['student_email'];?>&dob=<?php
                                    echo $row['student_dob'];?>&courseCode=<?php
                                    echo $row['student_course_code'];?>">Update</a>
                                </td>
                            </tr>
