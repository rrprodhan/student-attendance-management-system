...
<?php
    ...
    $tc = new Teacher();
    $deleteData = $tc->deleteTeacher($id,$courseCode);
?>
...
<body>
    <header class="header">
        ...
        <div class="panel panel-default container">
            ...
            <a href="update_teacher_list.php">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-dark" href="delete_teacher.php?id=<?php
                                    echo $row['teacher_id'];?>&courseCode=<?php
                                    echo $row['teacher_course_code'];?>">Delete
                                </a>
                            </td>
                        </tr>
